...
public class UUIDUtil {
    ...
    public static UUID nameUUIDFromNamespaceAndString(UUID namespace, String name) {
        return nameUUIDFromNamespaceAndBytes(namespace, Objects.requireNonNull(name, "name == null").getBytes(StandardCharsets.UTF_8));
    }


    public static UUID uuid3(UUID namespaceUUID, String myString) {
